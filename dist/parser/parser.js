...
tokenizer = {
    ...
    throwUnexpectedToken(symbol, line, column) {
        ...
        throw new SyntaxError(`${lineData}Unexpected token: "${symbol}" ` +
            `at ${line}:${column}.`);
    },
    getCursor() {
        return this._cursor;
    ...
    parse(string, parseOptions) {
        ...
        do {
            ...
            if (entry[0] === 's') {
                ...
                stack.push({ symbol: tokens[shiftedToken.type], semanticValue: shiftedToken.value, loc }, Number(entry.slice(1)));
            ...
            // Reduce action.
                ...
                const locationArgs = (hasSemanticAction && yy.options.captureLocations
                    ? []
                    : null);
                if (production[1] !== 0) {
                ...
                if (hasSemanticAction) {
                    ...
                    const semanticActionArgs = (locationArgs !== null
